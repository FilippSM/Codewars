...
letters as the animal's name. For example, 
...
console.log("feast: ", feast("great blue heron", "garlic naan"));
console.log("feast: ", feast("chickadee", "chocolate cake"));
console.log("feast: ", feast("brown bear", "bear claw"));