...
console.log("fixTheMeerkat: ", fixTheMeerkat(["tail", "body", "head"]));
console.log("fixTheMeerkat: ", fixTheMeerkat(["tails", "body", "heads"]));
console.log("fixTheMeerkat: ", fixTheMeerkat(["bottom", "middle", "top"]));