...
console.log("howManyDalmatians: ", howManyDalmatians(26));
console.log("howManyDalmatians: ", howManyDalmatians(80));
console.log("howManyDalmatians: ", howManyDalmatians(101));